  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
      <button
        ...
        size={size}
        className={cn(
          "absolute h-16 w-8 transition-all hover:backdrop-blur-md hover:bg-white/10 border border-transparent ",
          "flex items-center justify-center rounded-lg hover:shadow-md",
          orientation === "horizontal"
