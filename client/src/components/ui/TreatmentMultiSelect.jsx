    ...
    <Popover>
      <PopoverTrigger asChild>
        ...
        >
          ...
          <div className="[&_svg]:size-6 [&_svg]:shrink-0 text-customNeutral-700 transition-transform">
            <ChevronDownIcon />
          </div>
        </div>
      </PopoverTrigger>

      <PopoverContent className="min-w-[320px] bg-customNeutral-100 border shadow-md rounded-md p-2 max-h-60 overflow-y-auto">
